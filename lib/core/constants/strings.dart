...
class Strings {
  ...
  //General
  static const String APP_NAME = "Jawhara";
  ...
  //network
  // Todo production
  static const String MAIN_URL = "https://jawhara.online/";

  // Todo staging
  // static const String MAIN_URL = "https://staging-5em2ouy-qujjm6n5pmk6i.eu-5.magentosite.cloud/";
  static const String MAIN_API_URL_AR = "$MAIN_URL" + "rest/ar/V1/";
  ...
  static const String AR_HELP = "$MAIN_URL" + "help";
  static const String EN_HELP = "$MAIN_URL" + "en/help";

  // ignore: non_constant_identifier_names
  static String CART_MINE = "carts/mine/";
  static String CART_MINE_FIXED = "carts/mine/";
  static String DEFAULT_SHIPPING_CART = MOBILE + "carts/mine/estimate-shipping-methods";
  ...
  static const String PLACE_ORDER_WITH_SAVED_CARD = "payfort/payment/vault";
  ...
  // Staging Token
  // Todo staging
  // static const String ADMIN_TOKEN = "o31alfnhinao022y5wwd9iwiymyow34n";

  static String USER_TOKEN = "";
  static const String GUEST_IMAGE = "https://www.iconsdb.com/icons/download/light-gray/guest-512.jpg";

  static const kUpgradeURLConfig = {
    "android": "https://play.google.com/store/apps/details?id=online.jawhara",
