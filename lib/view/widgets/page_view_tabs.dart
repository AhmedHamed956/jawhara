...
class PageViewTabs extends StatefulWidget {
  ...
  @override
  _PageViewTabsState createState() => _PageViewTabsState();
}

class _PageViewTabsState extends State<PageViewTabs>
  ...
  void initState() {
    ...
    if (widget.disabledChangePageFromContentView)
